export default {
  um: [
    { value: "kWh", label: "kWh" },
    { value: "kWh/an", label: "kWh/an" },
    { value: "kWh/1000", label: "kWh/1000" },
    { value: "kWh/ciclu", label: "kWh/ciclu" },
  ],
  umTelevizoare: [
    { value: "kWh/1000 ore", label: "kWh/1000 ore" },
    { value: "kWh", label: "kWh" },
  ],
  umAragaz: [
    { value: "kWh/100 cicluri", label: "kWh/100 cicluri" },
    { value: "kWh/ciclu", label: "kWh/ciclu" },
  ],
  umAparatFrigorific:[
    { value: "kWh/an", label: "kWh/an" },
  ...
  stiri:[
    { value: "consum energetic", label: "consum energetic" },
    { value: "energie eoliana", label: "kWh/an" },
   
  ],
  timp:[
    { value: "zi", label: "zi" },
    { value: "saptamana", label: "saptamana" },
   
  ],
  categorie: [
    { value: "Televizoare", label: "Televizoare" },
    { value: "Aragazuri", label: "Aragazuri" },
    { value: "Aparate frigorifice", label: "Aparate frigorifice" },
    { value: "Plite", label: "Plite" },
    { value: "Cuptoare", label: "Cuptoare" },
    { value: "Hote", label: "Hote" },
    { value: "Masini de spalat vase", label: "Masini de spalat vase" },
    { value: "Masini de spalat rufe", label: "Masini de spalat rufe" },
    { value: "Uscatoare rufe", label: "Uscatoare rufe" },
  ],
  days: [
    { value: 1, label: 1 },
    { value: 2, label: 2 },
