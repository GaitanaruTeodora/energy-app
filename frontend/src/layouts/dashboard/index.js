...
function Dashboard() {
  ...
  const timp = [
    { valoare: 1, denumire: "zi" },
    { valoare: 7, denumire: "saptamana" },
    { valoare: 30, denumire: "luna" },
    { valoare: 365, denumire: "an" },
  ];
      ...
      <SuiBox py={3}>
        <SuiBox mb={3}>
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} sm={6} xl={3}>
              <DashboardCard
                title={{ text: "Cheltuieli lunare cu energia" }}
                    ...
                    {denumireConf == "" ? (
                      ...
                      <Grid item xs={12} sm={6}>
                        ...
                        <select
                          ...
                          value={denumireConf}
                          onChange={(e) => {
                            setDenumireConf(e.target.value);
                        ...
                        >
                          {allConfiguration !== undefined ? (
                            allConfiguration.configuraties.map((c) => {
        ...
        <SuiBox mb={3}>
          {totalConsum == 0 ? (
            <Grid item container direction="row">
              ...
              >
                {" "}
                Introduceti dispozitive in configuratie pentru a putea vizualiza grafice de consum !
              </SuiTypography>{" "}
            </Grid>
          ) : denumireConf == "" ? (
            <p></p>
